...
public class GetSwapDatesResponse implements FastCacheDVOBase  {
	...
	public SwapDate getswapDate() { 
		return _swapDate;
	}
	public void setswapDate(SwapDate newValue) { 
		_swapDate = newValue;
	}
	...
	public DataArray writeCache() throws FastCacheException {
		...
		item.putDataArray(_swapDate.writeCache());
		da.setDataItem(sa_idx++, item);
		item.DataItemClear();
		return da;
	}
	...
	private SwapDate _swapDate =  new SwapDate();
