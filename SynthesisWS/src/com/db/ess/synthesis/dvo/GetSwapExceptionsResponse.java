// Title:        GetSwapExceptionsResponse
...
public class GetSwapExceptionsResponse implements FastCacheDVOBase  {
	...
	public SwapException getswapException() { 
		return _swapException;
	}
	public void setswapException(SwapException newValue) { 
		_swapException = newValue;
	}
	...
	public DataArray writeCache() throws FastCacheException {
		...
		item.putDataArray(_swapException.writeCache());
		da.setDataItem(sa_idx++, item);
		item.DataItemClear();
		return da;
	}
	public void readCache(DataArray in) throws FastCacheException {
		...
		in.getDataItem(sa_idx++, item);
		item.getDataArray(daItem);
		_swapException.readCache(daItem);
	}
	...
	private SwapException _swapException =  new SwapException();
