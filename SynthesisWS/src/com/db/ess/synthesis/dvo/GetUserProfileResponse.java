...
public class GetUserProfileResponse implements FastCacheDVOBase  {
	...
	public void setuserProfile(UserProfile newValue) { 
	...
	public DataArray writeCache() throws FastCacheException {
		...
		item.putDataArray(_userProfile.writeCache());
		da.setDataItem(sa_idx++, item);
		item.DataItemClear();
		return da;
	}
