...
public class GetBooksRequest implements FastCacheDVOBase  {
	...
	public String getrequestType() {
		if(_requestType!=null) {
			return new String(_requestType);
		}
		else {
			return null;
		}
	...
	public void setrequestType(String newValue) {
		_requestType = newValue!=null ? newValue.toCharArray() : null;
	}
	...
	public DataArray writeCache() throws FastCacheException {
		...
		da.setDataItem(sa_idx++, item);
		item.putCharArray(_requestType);
		da.setDataItem(sa_idx++, item);
		item.DataItemClear();
		return da;
	}
	public void readCache(DataArray in) throws FastCacheException {
		...
		in.getDataItem(sa_idx++, item);
		_requestType = item.getCharArray();
	}
