...
import org.adaptinet.sdk.xmltoolsex.*;


//@SuppressWarnings("unchecked")
public class XMLReader extends org.adaptinet.sdk.xmltools.parser.BaseParser {
						...
						while (ch != -1 && ch != '>') {
							if (ch == '"') {
								...
								if (auri != null
									...
									if (auri != null) {
										auri = (String) namespaces.get(auri);
									}
    ...
    static public String normalize(String value) throws java.io.UnsupportedEncodingException {
        if (value == null || value.indexOf('&') == -1) {
            return value;
        }
        char[] ca = value.toCharArray();
        return normalize(ca,0,ca.length);
    }
