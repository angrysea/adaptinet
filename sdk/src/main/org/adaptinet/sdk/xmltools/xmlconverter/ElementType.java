...
import org.adaptinet.sdk.xmlutils.NameMangler;
	...
	public final String generateCode(boolean externalizable, boolean cacheable) {
		...
		try {
			...
			if (name != null) {
				...
				if (cacheable) {
					ret.append("import java.io.IOException;\n\n");
					ret.append("import org.adaptinet.sdk.adaptinetex.FastCacheException;\n");
					ret.append("import org.adaptinet.sdk.fastcache.CacheServer;\n");
					ret.append("import org.adaptinet.sdk.fastcache.DataArray;\n");
					ret.append("import org.adaptinet.sdk.fastcache.DataItem;\n");
					ret.append("import org.adaptinet.sdk.fastcache.FastCacheDVOBase;\n");
				}
