...
import org.adaptinet.sdk.scripting.ScriptElement;
import org.adaptinet.sdk.scripting.ScriptParent;
import org.adaptinet.sdk.scripting.ScriptStatement;
import org.adaptinet.sdk.xmlutils.IXMLInputSerializer;
import org.adaptinet.sdk.xmlutils.IXMLOutputSerializer;
	...
	public ScriptBlock load(String scriptFile, String xmlFile) {
		...
		try {
			inserial = XMLSerializerFactory
					.getInputSerializer();
		inserial.setPackage("org.adaptinet.sdk.scripting");
