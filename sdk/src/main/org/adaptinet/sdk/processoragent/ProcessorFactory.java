...
import org.adaptinet.sdk.serverutils.ThreadCache;


public class ProcessorFactory implements Runnable {

	static public final String MAIN = "main";
	static public final String MAINCLASS = "org.adaptinet.sdk.processoragent.MainProcessor";

	static public final String MAINTENANCE = "maintenance";
	static public final String MAINTENANCECLASS = "org.adaptinet.sdk.processoragent.MaintenanceProcessor";

	static public final String SERVICE = "service";
	static public final String SERVICECLASS = "org.adaptinet.sdk.processoragent.ServiceProcessor";

	static public final String CACHE = "cache";
	static public final String CACHECLASS = "org.adaptinet.sdk.cache.CacheProcessor";
	
	static public final String CONSOLE = "Console";
	static public final String CONSOLECLASS = "org.adaptinet.sdk.processors.Console";
	...
	public ProcessorFactory(String classpath, boolean v) {
		...
		processors = (Map<String, ProcessorState>) Collections
				.synchronizedMap(new HashMap<String, ProcessorState>());
		try {
