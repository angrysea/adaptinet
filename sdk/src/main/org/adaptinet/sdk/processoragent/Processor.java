...
import org.adaptinet.sdk.node.Node;
...
/**
 * The Processor class is an abstract class from which all client processors must
 * derive.
 */
public abstract class Processor extends ProcessorRoot {

	/**
	 * Gives a processor a chance to do one time initialization. Method is called
	 * when the processor is first loaded.
	 */
	public abstract void init();

	/**
	 * Gives a processor a chance to cleanup any outstanding resources this processor
	...
	/**
	 * This method is for notification of processors that the status of the nodes
	 * has changed
	 */
	...
	public final Object sendMessage(Message message, Object ... args)
		...
		try {
			...
			throw new ProcessorException(ProcessorException.SEVERITY_ERROR,
					ProcessorException.ANT_POSTFAILURE, message.getAddress()
							.getURI());
		}
	}
	...
	public final void localPostMessage(Message message, Object ... args)
		...
		try {
			...
			throw new ProcessorException(ProcessorException.SEVERITY_ERROR,
					ProcessorException.ANT_LOCALPOSTFAILURE, message.getAddress()
							.getURI());
		}
	}
	 ...
	 * @throws ProcessorException
	 */
	public final void postMessage(String toUri, IServer replyServer, Object ... args)
			throws ProcessorException {
	...
	/**
	 * Initiates the broadcast of the specified message to each node of this node
	 * @param toUri
	 * @param args
	 * @throws ProcessorException
	 */
	public final void broadcastMessage(String toUri, Object ... args)
		...
		try {
			...
			throw new ProcessorException(ProcessorException.SEVERITY_ERROR,
					ProcessorException.ANT_BROADCASTFAILURE, message.getAddress()
							.getURI());
		}
	}
	 ...
	 * @throws ProcessorException
	 */
	public final void broadcastMessage(String toUri, IServer replyServer, Object ... args)
			throws ProcessorException {
	...
	/**
	 * Gives a processor an opportunity to do any message preprocessing that may be
	 * required.
	 * 
	 * @param env
	 *            Envelope of message
	...
	public final Iterator<Node> getNodes(boolean all) {
		...
		try {
			return ((NetworkAgent) server.getService("networkagent"))
					.getValues(all);
		} catch (Exception e) {
			e.printStackTrace();
		}
