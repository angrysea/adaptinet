...
import org.adaptinet.sdk.xmltools.parser.Attributes;
import org.adaptinet.sdk.xmltools.parser.DefaultHandler;
import org.adaptinet.sdk.xmltools.parser.XMLReader;
import org.adaptinet.sdk.xmltoolsex.ParserException;
import org.adaptinet.sdk.xmlutils.IXMLInputSerializer;
import org.adaptinet.sdk.xmlutils.XMLSerializerFactory;
...
public class MessageParser extends DefaultHandler {
	...
	protected static final int PROCESSOR = 64;
		...
		try {
			...
			case ADDRESS:
				...
				if (tag.equalsIgnoreCase("Postfix")) {
					...
					type = PORT;
				} else if (tag.equalsIgnoreCase("Processor")) {
					type = PROCESSOR;
	...
	final public void characters(char buffer[], int start, int length)
		...
		try {
			...
			case PROCESSOR:
				address.setProcessor(new String(buffer, start, length));
				break;
