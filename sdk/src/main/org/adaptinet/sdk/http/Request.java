package org.adaptinet.sdk.http;
...
import org.adaptinet.sdk.mimehandlers.MimeBase;
		...
		try {
			...
			case XML_TEXT:
				mime = (MimeBase) Class.forName(
						"org.adaptinet.sdk.mimehandlers.MimeXML_" + type)
						.newInstance();
			...
			case DATA_TEXT:
				mime = (MimeBase) Class.forName(
						"org.adaptinet.sdk.mimehandlers.MimeData_" + type)
						.newInstance();
			...
			case COMMAND:
				mime = (MimeBase) Class.forName(
						"org.adaptinet.sdk.mimehandlers.MimeCommand_" + type)
						.newInstance();
			...
			case XML_WS:
				mime = (MimeBase) Class.forName(
						"org.adaptinet.sdk.mimehandlers.MimeXML_WS")
						.newInstance();
				mime.init(url, server);
				respond = true;
				break;
			...
			case MIME_BINARY:
				mime = (MimeBase) Class.forName(
						"org.adaptinet.sdk.mimehandlers.Mime_Binary")
						.newInstance();
				mime.init(url, server);
